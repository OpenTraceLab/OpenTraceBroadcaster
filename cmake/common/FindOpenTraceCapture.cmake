...
find_path(OpenTraceCapture_INCLUDE_DIR
  NAMES opentracecapture.h
  PATHS ${PC_OPENTRACECAPTURE_INCLUDE_DIRS}
  PATH_SUFFIXES opentracecapture
)

find_library(OpenTraceCapture_LIBRARY
  NAMES opentracecapture
  PATHS ${PC_OPENTRACECAPTURE_LIBRARY_DIRS}
)

include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(OpenTraceCapture
...
if(OpenTraceCapture_FOUND)
  ...
  if(NOT TARGET OpenTraceCapture::OpenTraceCapture)
    ...
    set_target_properties(OpenTraceCapture::OpenTraceCapture PROPERTIES
